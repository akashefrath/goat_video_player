...
#import GoatPlayerPlugin.h
#import <goat_player/goat_player-Swift.h>
...
@implementation GoatPlayerPlugin
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    GoatPlayerPlugin* instance = [[GoatPlayerPlugin alloc] initWithRegistrar:registrar];
...
#pragma mark - GoatPlayerPlugin class
- (int)newTextureId {
    texturesCount += 1;
